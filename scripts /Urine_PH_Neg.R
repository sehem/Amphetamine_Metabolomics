...
order <- c(10,14,12,9,6,13,8,15,16,7,1,2,3,4,5,11,17)
...
peaklist2 <- read.csv("peaklist.csv", header = TRUE)
...
if (length(matrix) > 1) 
  {
    ...
    heatmap.2(x = t(matrix), scale = "row", distfun = dist, margins = c(6,15), trace = "none")
